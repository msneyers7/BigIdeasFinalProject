...
- Monthly Criminal Data contains data of the amount of crimes reported in the previous full month(ex: it's November the crimes would be reported for October) and labels each with a neighborhood.
